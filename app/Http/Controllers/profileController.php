...
class profileController extends Controller
{
    ...
    function update(Request $request)
    {
        $request->validate([
            ...
            '_foto.mimes' => 'Foto yang dimasukkan hanya diperbolehkan berektensi JPEG, JPG, PNG,
            dan GIF',
        ...
        if ($request->hasFile('_foto')) {
           ...
           metadata::updateOrCreate(['meta_key' => '_foto'], ['meta_value' => 
           $foto_baru]);
        }
